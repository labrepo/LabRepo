...
class Experiment(models.Model):
    ...
    editors = models.ManyToManyField(settings.AUTH_USER_MODEL, related_name='experiments_editors', blank=True, null=True, verbose_name=_('editors'))
    viewers = models.ManyToManyField(settings.AUTH_USER_MODEL, related_name='experiments_viewers', blank=True, null=True, verbose_name=_('viewers'))
