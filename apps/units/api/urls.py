...
urlpatterns = patterns('',
    ...
    url(r'^(?P<unit_pk>[\d]+)/unit-links/$', views.UnitLinkListView.as_view(), name='api-links-list'),
    url(r'^(?P<unit_pk>[\d]+)/unit-links/(?P<pk>[\d]+)/$', views.UnitLinkDetailView.as_view(), name='api-links-detail'),
